...
public class ApkInfoEntity {
     ...
     * 暗指的特性。
     */
    private List<ImpliedFeatureEntity> impliedFeatures;
    ...
    public ApkInfoEntity() {
        ...
        this.impliedFeatures = new ArrayList<ImpliedFeatureEntity>();
    ...
    public void addToImpliedFeatures(ImpliedFeatureEntity impliedFeature) {
     ...
     * @return
     */
    public List<ImpliedFeatureEntity> getImpliedFeatures() {
        return impliedFeatures;
    }

    public void setImpliedFeatures(List<ImpliedFeatureEntity> impliedFeatures) {
